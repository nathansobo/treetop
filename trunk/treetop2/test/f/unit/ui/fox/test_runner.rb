  ...
  module Unit
    module UI
      module Fox
        ...
        # Runs a F::Unit::TestSuite in a Fox UI. Obviously,
        ...
        class TestRunner
          ...
          def create_application
            app = FXApp.new("TestRunner", "F::Unit")
            app.init([])
            app
          end
          
          def create_window(app)
            FXMainWindow.new(app, "F::Unit TestRunner", nil, nil, DECOR_ALL, 0, 0, 450)
          end
...
if __FILE__ == $0
  F::Unit::UI::Fox::TestRunner.start_command_line_test
end
