module F
  module Unit
    ...
    ##
    # F::Unit::Assertions contains the standard F::Unit assertions.
    # Assertions is included in F::Unit::TestCase.
    #
    # To include it in your own code and use its functionality, you simply
    # need to rescue F::Unit::AssertionFailedError. Additionally you may
...
EOT
      ...
      # include F::Unit::Assertions to record assertion counts.
