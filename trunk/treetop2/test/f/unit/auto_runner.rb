    ...
    class AutoRunner
      ...
      RUNNERS = {
        :console => proc do |r|
          ...
          F::Unit::UI::Console::TestRunner
        end,
        :gtk => proc do |r|
          require_runner 'gtk'
          F::Unit::UI::GTK::TestRunner
        end,
        :gtk2 => proc do |r|
          require_runner 'gtk2'
          F::Unit::UI::GTK2::TestRunner
        end,
        :fox => proc do |r|
          require_runner 'fox'
          F::Unit::UI::Fox::TestRunner
        end,
        :tk => proc do |r|
          require_runner 'tk'
          F::Unit::UI::Tk::TestRunner
        end,
      }
      ...
      def options
        @options ||= OptionParser.new do |o|
          o.banner = "F::Unit automatic runner."
