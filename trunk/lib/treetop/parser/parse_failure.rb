module Treetop
  class ParseFailure
    attr_reader :parsing_expression, :consumed_interval, :nested_failures, :matched_interval_begin
    ...
    def initialize(matched_interval_begin, parsing_expression, nested_failures = [])
      ...
      @consumed_interval = matched_interval_begin...matched_interval_begin
    end
