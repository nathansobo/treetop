...
Metagrammar.add_parsing_rule(::Treetop::ParsingRule.new(Metagrammar.nonterminal_symbol(:treetop_file), ::Treetop::ZeroOrMore.new(::Treetop::OrderedChoice.new([Metagrammar.nonterminal_symbol(:grammar), Metagrammar.nonterminal_symbol(:arbitrary_character)])) {
        def to_ruby
          elements.map { |elt| elt.to_ruby }.join
        end
      }))
Metagrammar.add_parsing_rule(::Treetop::ParsingRule.new(Metagrammar.nonterminal_symbol(:arbitrary_character), ::Treetop::AnythingSymbol.new {
        def to_ruby
          text_value
        end
      }))
...
Metagrammar.add_parsing_rule(::Treetop::ParsingRule.new(Metagrammar.nonterminal_symbol(:primary), ::Treetop::OrderedChoice.new([::Treetop::Sequence.new([Metagrammar.nonterminal_symbol(:instantiator_primary), Metagrammar.nonterminal_symbol(:node_class_expression), Metagrammar.nonterminal_symbol(:trailing_block)]) {
        def to_ruby(grammar_node)
...
Metagrammar.add_parsing_rule(::Treetop::ParsingRule.new(Metagrammar.nonterminal_symbol(:node_class_expression), ::Treetop::OrderedChoice.new([::Treetop::Sequence.new([Metagrammar.nonterminal_symbol(:space), ::Treetop::TerminalSymbol.new('<'), ::Treetop::OneOrMore.new(::Treetop::Sequence.new([::Treetop::NotPredicate.new(::Treetop::TerminalSymbol.new('>')), ::Treetop::AnythingSymbol.new])), ::Treetop::TerminalSymbol.new('>')]) {
        def to_ruby
