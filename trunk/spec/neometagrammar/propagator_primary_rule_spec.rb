...
describe "A parser for the subset of the metagrammar rooted at the propagator_primary rule" do
  ...
  it "successsfully parses ! preceding zero or more of a parenthesized choice"
  
  it "successsfully parses an optional nonterminal"
  
  it "successsfully parses an optional terminal"
