...
describe "An instance of TerminalParseFailure" do
  setup do
  ...
  it "has a zero length matched_interval at the beginning of the match interval because it has no nested failures" do
